  ...
  try {
    ...
    const ingredient = await prisma.ingredient.create({
      data: {
        ...
        category,
        description,
        cookingState: cookingState || 'before_cook',
        // Before cook values
        caloriesBefore: parseFloat(caloriesBefore) || 0,
        proteinBefore: parseFloat(proteinBefore) || 0,
        carbsBefore: parseFloat(carbsBefore) || 0,
        fatsBefore: parseFloat(fatsBefore) || 0,
        // After cook values
        caloriesAfter: parseFloat(caloriesAfter) || 0,
        proteinAfter: parseFloat(proteinAfter) || 0,
        carbsAfter: parseFloat(carbsAfter) || 0,
        fatsAfter: parseFloat(fatsAfter) || 0,
        // Common values
